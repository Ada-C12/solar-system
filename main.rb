...
#Wave 3
def verify_planet(solar_system, user_planet)
...
def main 
  ...
  loop do 
    ...
    if user_input == "A"
      ...
      user_planet = gets.chomp.upcase 
      puts "\n" + (verify_planet(solar_system, user_planet)).summary
    elsif user_input == "C"
      ...
      origin_planet = verify_planet(solar_system, origin_input)
      puts "What is the destination planet?"
      destination_input = gets.chomp.upcase
      destination_planet = verify_planet(solar_system, destination_input)
